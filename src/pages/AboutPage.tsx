    ...
    <div className="min-h-screen pt-20 bg-background">
      <div className="container-wide py-16 max-w-3xl">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="font-heading font-bold text-4xl text-foreground mb-6">About Live101</h1>
          <p className="text-muted-foreground leading-relaxed mb-6">
            Live101 is India's premier artist booking marketplace, connecting talented performers with event planners across 150+ cities. From intimate house parties to grand corporate galas, we make finding and booking the perfect artist effortless.
          </p>
          <p className="text-muted-foreground leading-relaxed mb-6">
