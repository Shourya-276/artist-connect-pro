      ...
      <div className="container-wide py-16 max-w-3xl">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          ...
          <div className="prose prose-sm text-muted-foreground space-y-4">
            <p>Welcome to ArtistHub. By using our platform, you agree to these terms of service.</p>
            <h3 className="font-heading font-semibold text-foreground">1. Platform Usage</h3>
            <p>ArtistHub provides a marketplace connecting artists with event planners. We facilitate connections but are not party to agreements between artists and clients.</p>
