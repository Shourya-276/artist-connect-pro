  ...
  return (
    ...
    >
      <div className="relative aspect-[4/3] overflow-hidden">
        ...
        <button className="absolute top-3 right-3 w-9 h-9 rounded-full glass flex items-center justify-center hover:bg-primary hover:text-primary-foreground transition-all">
          <Heart size={16} />
        </button>
      ...
      <div className="p-4">
        ...
        <div className="flex gap-2 mt-3">
          ...
          <Button size="sm" className="flex-1 text-xs">Shortlist</Button>
        </div>
      </div>
    </motion.div>
  );
